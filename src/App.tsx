...
import {AddInStack, deleteInStack}  from './dataEstructures/createEvent'
...
function App() {
  ...
  return (
    <div>
      <div>Helo word</div>
      <button className='p-8' onClick={AddInStack} >crear nuevo evento</button> 
      <button className='p-8' onClick={deleteInStack} >eliminar evento</button> 
